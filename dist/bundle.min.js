...
exports.enterPlayerName = enterPlayerName;
exports.addPlayer = addPlayer;
exports.getNumSelectedPlayers = getNumSelectedPlayers;
exports.matchPlayers = matchPlayers;
exports.resetPlayers = resetPlayers;
exports.randomPlayers = randomPlayers;
exports.selectedPlayer = selectedPlayer;
 ...
 */
function enterPlayerName(newName) {
 ...
 */
function addPlayer(playerName, playerField) {
 ...
 * @param {array} players - Array of player objects
 */
function getNumSelectedPlayers(players) {
 ...
 */
function matchPlayers(players, maxPlayers) {
    console.log("Match players!");
    var buffer = getSelectedPlayers(players);
...
function resetPlayers(players) {
    ...
    var res = players.map(function (e) {
        e.selected = false;
        return e;
    });
    return this.setState({
 ...
 */
function randomPlayers(maxPlayers, allPlayers) {
    console.log("Randomize players!");
    var selection = getRandomIndices(maxPlayers, allPlayers.length);
    var players = allPlayers.map(function (e, index) {
...
function selectedPlayer(playerName) {
    ...
    var numSelected = getNumSelectedPlayers(this.state.players),
 ...
 */
function listPlayers(players, clickAction) {
    if (players.length > 0) {
        return players.map(function (player, index) {
            return _react2.default.createElement(
                "li",
                { key: index, className: player.selected ? "active-player" : "", onClick: function onClick() {
                        return clickAction(player.name);
                    } },
                player.name
            );
        });
 ...
 */
function listPairings(pairings) {
...
var _AppComp = __webpack_require__(172);

var _AppComp2 = _interopRequireDefault(_AppComp);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_AppComp2.default, null), document.getElementById('mainApp'));
...
var _HeaderComp = __webpack_require__(173);

var _HeaderComp2 = _interopRequireDefault(_HeaderComp);

var _SectionComp = __webpack_require__(176);

var _SectionComp2 = _interopRequireDefault(_SectionComp);

var _ModalComp = __webpack_require__(177);

var _ModalComp2 = _interopRequireDefault(_ModalComp);

var _HelperMethods = __webpack_require__(90);

var Helpers = _interopRequireWildcard(_HelperMethods);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.maxPlayers = 4;
    _this.enterPlayerName = Helpers.enterPlayerName.bind(_this);
    _this.addPlayer = Helpers.addPlayer.bind(_this);
    _this.matchPlayers = Helpers.matchPlayers.bind(_this);
    _this.resetPlayers = Helpers.resetPlayers.bind(_this);
    _this.randomPlayers = Helpers.randomPlayers.bind(_this);
    _this.selectedPlayer = Helpers.selectedPlayer.bind(_this);
    _this.getNumSelectedPlayers = Helpers.getNumSelectedPlayers.bind(_this);
    _this.closeModal = Helpers.closeModal.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_HeaderComp2.default, {
          change: this.enterPlayerName,
          add: function add() {
            return _this2.addPlayer(_this2.state.playerName, _this2.state.players);
          },
          match: function match() {
            return _this2.matchPlayers(_this2.state.players, _this2.maxPlayers);
          },
          reset: function reset() {
            return _this2.resetPlayers(_this2.state.players);
          },
          random: function random() {
            return _this2.randomPlayers(_this2.maxPlayers, _this2.state.players);
          },
          selectedPlayers: this.getNumSelectedPlayers(this.state.players),
          totalPlayers: this.state.players.length,
          inputValue: this.state.playerName
        }),
        _react2.default.createElement(_SectionComp2.default, {
          id: 'player-field',
        ...
        this.state.pairings.length != 0 ? _react2.default.createElement(_SectionComp2.default, {
          id: 'matched-field',
          title: 'Matched players',
          description: 'Pairings are up. Have fun!',
          pairs: this.state.pairings }) : null,
        this.state.warning.display ? _react2.default.createElement(_ModalComp2.default, {
          text: this.state.warning.message,
          classes: this.state.warning.display ? "fade in modal-display" : "",
          close: this.closeModal
        }) : null,
        this.state.warning.display ? _react2.default.createElement('div', { className: 'modal-backdrop fade in' }) : null
      );
    }
  }]);
...
var _ButtonComp = __webpack_require__(174);

var _ButtonComp2 = _interopRequireDefault(_ButtonComp);

var _InputComp = __webpack_require__(175);
...
var Header = function (_React$Component) {
    ...
    function Header(props) {
        ...
        _this.counter = counter.bind(_this);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { id: 'controls', className: 'form-group' },
                    _react2.default.createElement(
                        'label',
                        null,
                        this.state.label
                    ),
                    _react2.default.createElement(_InputComp2.default, { onChange: this.props.change, value: this.props.inputValue }),
                    _react2.default.createElement(_ButtonComp2.default, { classes: 'add', text: 'Add', onClick: function onClick() {
                            _this2.props.add();_this2.counter();
                        } }),
                    _react2.default.createElement(_ButtonComp2.default, { classes: 'start', text: 'Pairings', onClick: this.props.match, disabled: this.props.selectedPlayers < 4 ? true : false }),
                    _react2.default.createElement(_ButtonComp2.default, { classes: 'random', text: 'Randomize', onClick: this.props.random, disabled: this.props.totalPlayers < 4 || this.props.selectedPlayers == 4 ? true : false }),
                    _react2.default.createElement(_ButtonComp2.default, { classes: 'reset', text: 'Reset', onClick: this.props.reset })
                )
            );
        }
    }]);
...
var Button = function (_React$Component) {
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'button',
                { className: classes, type: 'button', onClick: function onClick() {
...
var Input = function (_React$Component) {
    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('input', { type: 'text', className: 'input-style', value: this.props.value, onChange: function onChange(e) {
...
var Section = function (_React$Component) {
    ...
    function Section(props) {
        ...
        _this.listPlayers = Helpers.listPlayers.bind(_this);
        _this.listPairings = Helpers.listPairings.bind(_this);
        return _this;
    }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'ul',
                    null,
                    this.props.players ? this.listPlayers(this.props.players, this.props.selected) : this.props.pairs ? this.listPairings(this.props.pairs) : null
                )
            );
        }
    }]);
...
var Modal = function (_React$Component) {
    ...
    _createClass(Modal, [{
        ...
        value: function render() {
            ...
            var classes = "modal " + this.props.classes;
            return _react2.default.createElement(
                'div',
